...
//
//public class ServicePeriodicsImpl extends ServiceGeneratorAbstract<Periodic> implements SubjectAdd<Periodic> {
//
//    public void generator(int count) {
//        new GeneratorImpl(this, count);
//    }
//
//    @Override
//    public Boolean add(Periodic value) {
