...
public class ServiceProviderDriverReleaseBooks extends ServiceProviderImpl implements ServiceProvider {
    ...
    public MessageTransfer sendOffer() {
        ...
        System.out.println(ServerHandler.threadName + " userId = " + userId);
        System.out.println(ServerHandler.threadName + " offerBooks.size = " + loanBooks.size());
    ...
    public MessageTransfer processAnswer() {
        ...
        String bo = lol.getBook().getShortInfo();
        String us = lol.getUser().getShortInfo();

        System.out.println(ServerHandler.threadName + " - " + bo + " + " + us);

        boolean b  = lending.removeLoan(lol);

        if (b) {
            menu.add( "OK -> " + us + " vrátil " + bo);
        } else {
            menu.add( "Chyba -> " + us + " nelze vrátit " + bo);
        }
